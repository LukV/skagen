<template>
      ...
      <v-row justify="center" align="start">
        <v-col cols="12" md="6" lg="4">
          ...
          <v-row justify="center">
            <v-img
              src="@/assets/images/skagen-icon.png"
              max-width="48"
              class="ma-12"
              alt="Skågen Logo"
            ></v-img>
          ...
          <v-card color="surface" outlined class="pa-6">
            ...
            <v-form ref="signupForm" v-model="isFormValid">
              ...
              <v-row justify="center" class="mb-3">
                <v-btn color="primary" size="large" class="mb-4" :disabled="!isFormValid" @click="submitForm">
                Sign up
              </v-btn>
  ...
  .terms-text {
    font-size: 12px;
    color: var(--v-subtext-base); /* Adjust this for clr--subtext */
  }
  ...
  .divider-or .or-text {
    position: absolute;
    background-color: #fff; /* White background for OR */
    padding: 0 10px;
    top: -12px;
    color: #666;
    font-size: 14px;
